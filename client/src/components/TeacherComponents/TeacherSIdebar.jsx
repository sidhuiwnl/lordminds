        ...
        <div className="space-y-1">
          ...
          {isResultsOpen && (
            <div className="ml-4 lg:ml-2 space-y-1 border-l-2 border-blue-400/30 pl-2 py-1">
              {/* Current Marks */}
              <button
                onClick={() => handleSubMenuClick("current-marks", "/teacher/currentmarks")}
              ...
              {/* Assignment Marks */}
              <button
                onClick={() => handleSubMenuClick("assignment-marks", "/teacher/assignmentmarks")}
                className={`flex items-center gap-3 w-full px-3 py-2 font-medium transition-all duration-200 rounded-lg text-xs lg:text-sm ${
              ...
              {/* Total Duration */}
              <button
                onClick={() => handleSubMenuClick("total-duration", "/teacher/totalduration")}
                className={`flex items-center gap-3 w-full px-3 py-2 font-medium transition-all duration-200 rounded-lg text-xs lg:text-sm ${
              ...
              {/* Overall Results */}
              <button
                onClick={() => handleSubMenuClick("overall-results", "/teacher/overallresult")}
                className={`flex items-center gap-3 w-full px-3 py-2 font-medium transition-all duration-200 rounded-lg text-xs lg:text-sm ${
