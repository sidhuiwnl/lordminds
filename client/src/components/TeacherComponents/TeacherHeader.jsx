...
const TeacherHeader = ({ onMenuToggle }) => {
  ...
  const getProfileImageSrc = () => {
    if (user?.profile_image) return `${import.meta.env.VITE_BACKEND_API_URL}/uploads/${user.profile_image}`;
    ...
    >
      ...
      <div className="flex items-center gap-4 lg:gap-6 w-full lg:w-auto lg:absolute lg:top-6 lg:right-8 justify-end lg:justify-start">
        ...
        <img
          ...
          className="w-8 h-8 rounded-full object-cover flex-shrink-0 cursor-pointer hover:scale-105 transition-transform border-2 border-white shadow-sm"
        />
