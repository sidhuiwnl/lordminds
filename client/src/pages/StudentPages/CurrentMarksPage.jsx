...
import CurrentMarks from "../../components/StudentComponents/CurrentMarks";

const CurrentMarksPage = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50 lg:bg-white">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        {/* Floating Hamburger — Hidden when menu is open */}
        <div
...
export default CurrentMarksPage;